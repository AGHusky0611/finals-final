...
public class _PlayerInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements Server.PlayerSide.PlayerInterface
{
  ...
  public String getLobbyHost (int lobbyId) throws Server.Exceptions.LostConnectionException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  // Lobby Management
  public int createLobby (String userToken, String lobbyName) throws Server.Exceptions.LostConnectionException, Server.Exceptions.NotLoggedInException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return createLobby (userToken, lobbyName        );
            } finally {
                _releaseReply ($in);
            }
  } // createLobby

  public boolean joinLobby (String userToken, int lobbyId) throws Server.Exceptions.LostConnectionException, Server.Exceptions.NotLoggedInException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return joinLobby (userToken, lobbyId        );
            } finally {
                _releaseReply ($in);
            }
  } // joinLobby

  public void deleteLobby (int lobbyID) throws Server.Exceptions.LostConnectionException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public boolean removePlayerFromLobby (int lobbyId, String username) throws Server.Exceptions.LostConnectionException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return removePlayerFromLobby (lobbyId, username        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public String getHostUsername (String userId, int lobbyId) throws Server.Exceptions.LostConnectionException, Server.Exceptions.NotLoggedInException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getHostUsername", true);
                $out.write_string (userId);
                $out.write_long (lobbyId);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                ...
                return getHostUsername (userId, lobbyId        );
            } finally {
                _releaseReply ($in);
            }
  } // getHostUsername
