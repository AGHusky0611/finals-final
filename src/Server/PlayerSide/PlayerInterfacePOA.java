 ...
 implements Server.PlayerSide.PlayerInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getHostUsername", new java.lang.Integer (22));
    _methods.put ("getLeaderboard", new java.lang.Integer (23));
    _methods.put ("getLobbyList", new java.lang.Integer (24));
  }
  ...
  // Lobby Management
       ...
       case 22:  // Server/PlayerSide/PlayerInterface/getHostUsername
       {
         try {
           String userId = in.read_string ();
           int lobbyId = in.read_long ();
           String $result = null;
           $result = this.getHostUsername (userId, lobbyId);
           out = $rh.createReply();
           out.write_string ($result);
         } catch (Server.Exceptions.LostConnectionException $ex) {
           out = $rh.createExceptionReply ();
  ...
  // Leaderboard
       case 23:  // Server/PlayerSide/PlayerInterface/getLeaderboard
       {
         try {
           String userId = in.read_string ();
           String $result[] = null;
       ...
       case 24:  // Server/PlayerSide/PlayerInterface/getLobbyList
       {
         try {
           String userId = in.read_string ();
           String $result[] = null;
