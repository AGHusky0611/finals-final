 ...
 implements Server.AdminSide.AdminInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("createPlayer", new java.lang.Integer (1));
    _methods.put ("editUserDetails", new java.lang.Integer (2));
    _methods.put ("deleteUser", new java.lang.Integer (3));
    _methods.put ("getUserList", new java.lang.Integer (4));
    _methods.put ("searchUser", new java.lang.Integer (5));
    _methods.put ("changeRules", new java.lang.Integer (6));
    _methods.put ("getGameHistory", new java.lang.Integer (7));
    _methods.put ("getPlayerHistory", new java.lang.Integer (8));
