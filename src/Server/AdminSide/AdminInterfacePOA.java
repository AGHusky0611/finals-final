...
public abstract class AdminInterfacePOA extends org.omg.PortableServer.Servant
 implements Server.AdminSide.AdminInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("editUserDetails", new java.lang.Integer (1));
    _methods.put ("deleteUser", new java.lang.Integer (2));
    _methods.put ("getUserList", new java.lang.Integer (3));
    _methods.put ("searchUser", new java.lang.Integer (4));
    _methods.put ("changeRules", new java.lang.Integer (5));
    _methods.put ("getGameHistory", new java.lang.Integer (6));
    _methods.put ("getPlayerHistory", new java.lang.Integer (7));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Server/AdminSide/AdminInterface/createPlayer
       {
         try {
       ...
       case 1:  // Server/AdminSide/AdminInterface/editUserDetails
       {
         try {
       ...
       case 2:  // Server/AdminSide/AdminInterface/deleteUser
       {
         try {
           String userId = in.read_string ();
       ...
       case 3:  // Server/AdminSide/AdminInterface/getUserList
       {
         try {
           Server.CommonObjects.User $result[] = null;
           $result = this.getUserList ();
           out = $rh.createReply();
           Server.AdminSide.usersHelper.write (out, $result);
         } catch (Server.Exceptions.LostConnectionException $ex) {
           out = $rh.createExceptionReply ();
           Server.Exceptions.LostConnectionExceptionHelper.write (out, $ex);
         } catch (Server.Exceptions.NotLoggedInException $ex) {
       ...
       case 4:  // Server/AdminSide/AdminInterface/searchUser
       {
         try {
           String playerId = in.read_string ();
           Server.CommonObjects.User $result = null;
       ...
       case 5:  // Server/AdminSide/AdminInterface/changeRules
       {
         try {
       ...
       case 6:  // Server/AdminSide/AdminInterface/getGameHistory
       {
         try {
           Server.CommonObjects.GameResult $result[] = null;
           $result = this.getGameHistory ();
           out = $rh.createReply();
           Server.AdminSide.playedSessionsHelper.write (out, $result);
         } catch (Server.Exceptions.LostConnectionException $ex) {
           out = $rh.createExceptionReply ();
           Server.Exceptions.LostConnectionExceptionHelper.write (out, $ex);
         } catch (Server.Exceptions.NotLoggedInException $ex) {
       ...
       case 7:  // Server/AdminSide/AdminInterface/getPlayerHistory
       {
         try {
           String playerId = in.read_string ();
           Server.CommonObjects.GameResult $result[] = null;
       ...
       case 8:  // Server/AdminSide/AdminInterface/ping
       {
         try {
           String userId = in.read_string ();
           String $result = null;
